...
class TestFuckerLorem < Test::Unit::TestCase

  def setup
    @tester = Fucker::Lorem
    @standard_wordlist = I18n.translate('fucker.lorem.words')
    @complete_wordlist =
      @standard_wordlist + I18n.translate('fucker.lorem.supplemental')
  end
  ...
  # Fucker::Lorem.word generates random word from standart wordlist
  def test_word
    @tester = Fucker::Lorem
    @standard_wordlist = I18n.translate('fucker.lorem.words')
