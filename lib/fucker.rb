    ...
    class << self
      ...
      def parse(key)
        fetch(key).scan(/(\(?)#\{([A-Za-z]+\.)?([^\}]+)\}([^#]+)?/).map {|prefix, kls, meth, etc|
          ...
          cls = kls ? Fucker.const_get(kls.chop) : self
          ...
          # fetch the transation (i.e., fucker.name.first_name)
      ...
      def translate(*args)
        ...
        opts[:locale] ||= Fucker::Config.locale
        opts[:raise] = true
      ...
      # Then you can call Fucker::Name.girls_name and it will act like #first_name
      def method_missing(m, *args, &block)
        super unless @flexible_key

        # Use the alternate form of translate to get a nil rather than a "missing translation" string
        if translation = translate(:fucker)[@flexible_key][m]
...
require 'fucker/address'
require 'fucker/code'
require 'fucker/company'
require 'fucker/finance'
require 'fucker/internet'
require 'fucker/lorem'
require 'fucker/name'
require 'fucker/team'
require 'fucker/phone_number'
require 'fucker/business'
require 'fucker/commerce'
require 'fucker/version'
require 'fucker/number'
require 'fucker/bitcoin'
require 'fucker/avatar'
require 'fucker/date'
require 'fucker/time'
require 'fucker/number'
