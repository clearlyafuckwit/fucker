...
class TestFuckerBusiness < Test::Unit::TestCase

  def setup
    @tester = Fucker::Business
    @credit_card_number_list = I18n.translate('fucker.business.credit_card_numbers')
    @credit_card_number_expiry_dates = I18n.translate('fucker.business.credit_card_expiry_dates')
    @credit_card_types = I18n.translate('fucker.business.credit_card_types')
  end
